				...
				<div className="p-3 md:p-4 border-b border-gray-200">
					...
					<div className="mt-2 md:mt-3">
						...
						<select
							...
							className="w-full px-3 py-2 text-xs md:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white"
						>
						...
						<div className="p-4 text-center text-muted-foreground">
							{searchQuery ? (
								...
								<>
									...
									<p className="text-xs md:text-sm mt-2">Inicia una conversación desde Búsqueda de Talento.</p>
								</>
							)}
						</div>
					) : (
							...
							return (
								...
								>
									<div className="flex justify-between items-start mb-1">
										<h3 className="font-semibold text-sm md:text-base text-foreground">{conv.candidateName}</h3>
										{unreadCount > 0 && (
									...
									<p className="text-xs md:text-sm text-muted-foreground truncate">{conv.lastMessage || 'Nueva conversación'}</p>
				...
				{selectedConversation ? (
							...
							<div className="flex items-center justify-between">
								<div className="flex items-center gap-2 md:gap-3 min-w-0 flex-1">
									...
									<div className="min-w-0 flex-1">
										<h2 className="text-base md:text-lg font-semibold text-foreground truncate">{selectedConversation.candidateName}</h2>
										<p className="text-xs md:text-sm text-muted-foreground">Candidato</p>
									</div>
								</div>
					...
					<div className="flex-1 flex items-center justify-center p-4">
						<div className="text-center text-muted-foreground">
							...
							<p className="text-xs md:text-sm">o inicia una nueva desde Búsqueda de Talento</p>
						</div>
					</div>
				)}
			</div>
