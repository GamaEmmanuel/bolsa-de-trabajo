						...
						<div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
							...
							{submitted ? (
								<div className="text-center py-10">
									...
									<Link href="/" className="mt-6 inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-pink-600 hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
										Go to Homepage
									</Link>
								</div>
							) : (
							...
							<div className="bg-blue-50 p-6 rounded-lg">
								...
								<div className="flex flex-col sm:flex-row gap-3">
									...
									<Link
										...
										className="px-4 py-2 bg-white text-pink-600 border border-pink-600 rounded-lg font-medium hover:bg-blue-50 transition-colors text-center"
									>
										Start as Company
									</Link>
								</div>
